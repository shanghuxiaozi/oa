...
/**
 * 普通活动 控制层 名称：ActivityController.java<br>
 * 描述：<br>
 * 类型：JAVA<br>
 * 最近修改时间: 2017年11月7日 下午7:55:00 <br>
 * 
 * @since 2017年11月7日
 * @authour wenxun
 */
...
public class ActivityController {
	...
	public Result addPoints(String activityId, String userId) {
		...
		integralDetails.setUserId(integral.getUserId());
	...
	@ResponseBody
	public Result saveActivityImg(String json1,String json2,String json3,String json4){
		List<MfUserImage> userImageList = new ArrayList<MfUserImage>();
		MfUserImage userImage1 = JSON.parseObject(json1,MfUserImage.class);
		userImage1.setUserId("abcdefghijklmnopqrstuvwxyz");
		userImage1.setCreateTime(new Date());
		userImage1.setImageType("3");
		userImage1.setIsUse("1");
		MfUserImage userImage2 = JSON.parseObject(json2,MfUserImage.class);
		userImage2.setUserId("abcdefghijklmnopqrstuvwxyz");
		userImage2.setCreateTime(new Date());
		userImage2.setImageType("3");
		userImage2.setIsUse("1");
		MfUserImage userImage3 = JSON.parseObject(json3,MfUserImage.class);
		userImage3.setUserId("abcdefghijklmnopqrstuvwxyz");
		userImage3.setCreateTime(new Date());
		userImage3.setImageType("3");
		userImage3.setIsUse("1");
		MfUserImage userImage4 = JSON.parseObject(json4,MfUserImage.class);
		userImage4.setUserId("abcdefghijklmnopqrstuvwxyz");
		userImage4.setCreateTime(new Date());
		userImage4.setImageType("3");
		userImage4.setIsUse("1");
		userImageList.add(userImage1);
		userImageList.add(userImage2);
		userImageList.add(userImage3);
		userImageList.add(userImage4);
		mfUserImageService.batchAdd(userImageList);
