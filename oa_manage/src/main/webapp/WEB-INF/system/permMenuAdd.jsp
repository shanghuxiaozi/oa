...
<body class="body">
	...
	<form class="layui-form  layui-form-pane" action=""
		...
		<div class="layui-form-item" pane>
			...
			<div class="layui-input-block">
				<input type="text" name="name" lay-verify="required"
					...
					onchange="valueChange('name',this)" />
			</div>
		</div>
		<div class="layui-form-item" pane>
			...
			<div class="layui-input-block">
				...
				<input type="text" name="pname" readonly="readonly"
					id="pname" value="${parentPerm.name}" onclick="menuTrees()"
					autocomplete="off" class="layui-input" />
			</div>
		</div>
		<div class="layui-form-item" pane>
			...
			<div class="layui-input-block" onclick="radioType(this)">
				<input type="radio" name="isParent" title="有" value="true" checked="checked" id="isLeaf1" /> 
				<input type="radio" name="isParent" title="无" value="false" id="isLeaf0" />
			</div>
		</div>
		<div class="layui-form-item url" style="display: none;">
			...
			<div class="layui-input-block">
				<input type="text" name="url" id="url" autocomplete="off"
					class="layui-input" onchange="valueChange('url',this)" />
			</div>
		</div>
		<div class="layui-form-item permissionName" style="display: none;">
		...
		<div class="layui-form-item" pane>
			...
			<div class="layui-input-block">
				<input type="text" name="permissionValue" lay-verify="required"
					autocomplete="off" class="layui-input"
		...
		<div class="layui-form-item" pane>
			...
			<div class="layui-input-block">
				<input type="text" name="orderNum" id="orderNum" lay-verify="number" value="99"
					autocomplete="off" class="layui-input" />
			</div>
		</div>
		<div class="layui-form-item" pane>
			...
			<div class="layui-input-block">
				<input type="text" name="iconCode" autocomplete="off"
					class="layui-input" /> <a
