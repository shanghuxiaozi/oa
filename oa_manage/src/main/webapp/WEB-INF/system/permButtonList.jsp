...
<body class="body">
  <div class="layui-row">
    <div class="layui-col-md4 co" style="width: 15%;">
    	<blockquote class="layui-elem-quote" style="height:96%;">
    ...
    <div class="layui-col-md8 co" style="width: 85%;">
	     ...
	     <form class="layui-form" action="" target="nm_iframe">
			<blockquote class="layui-elem-quote">
			   	<div class="layui-form-item">
			        <span class="layui-form-label">按钮名称：</span>
				    <div class="layui-input-inline">
				   		<input type="text" name="name" id="name" autocomplete="off" placeholder="按钮名称" class="layui-input" />
				    </div>
		...
		<table id="dateTable" class="layui-table">
		    ...
		    <tr id="trs">
		        ...
		        <th name="name">按钮名称</th>
		        <th name="pname">所属菜单</th>
		        <th name="permissionName">授权名称</th>
		        <th name="permissionValue">授权标识</th>
				<th name="orderNum"  style="text-align: center">排序</th>
				<th name="available"   style="text-align: center">是否启用</th>
...
<script type="text/javascript" src="${basePath }/static/js/system/buttonList.js"></script>
