...
<!-- 		<button type="button" class="layui-btn layui-btn-normal" id="import">导入数据</button> -->
		<button type="button" class="layui-btn " id="downLoadBtn">下载excel表格</button>
...
<!-- 下载用户资料表格 -->
<form id="downLoadForm" action="/pay/downloadUserDataMy" method="post">
	...
	table.render({
		 ...
		 // ,height: 590 		 		//容器高度
		  ...
		  ,response: {
	 	  ...
	 	  ,url: js_path+'/pay/queryDynamicByaccount'
	 	  //设置表头  进行数据渲染
	 	  ,cols:[[
