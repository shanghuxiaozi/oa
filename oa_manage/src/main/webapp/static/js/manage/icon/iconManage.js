...
function getParametersJson(){
	  ...
	  var t=new Object();
	  t.name=$("#name").val();
	  var iconManageVo=new Object();
	  iconManageVo.page=currentPage - 1;
	  iconManageVo.pageSize=10;
	  iconManageVo.t=t;
	  return JSON.stringify(iconManageVo);
}
...
layui.use(['table','form','element','layer'], function(){
        ...
        var options = {
        	...
        	url:js_path+'/iconManage/queryDynamic',//查询接口
        ...
        function editData(item,row){
        	var layerEdit = layer.open({
                ...
                shade: 0,
                maxmin: true,
                content:js_path+'/iconManage/edit?id='+item.id,
                btn: ['确定', '取消'], //只是为了演示
      ...
      //删除调用方法
        ...
        function detailData(item,row){
        	var layerEdit = layer.open({
                ...
                shade: 0,
                maxmin: true,
                content:js_path+'/iconManage/detail?id='+item.id,
                btn: ['关闭'],
                yes: function(index,layero){
                	layer.closeAll();
                }
       ...
       $('#add').click(function(e){
        	var layerAdd=layer.open({
                 ...
                 shade:['0.3','#000'],
                 maxmin: true,
                 content:js_path+'/iconManage/add',
                 btn: ['确认', '取消'],
                 yes: function(index,layero){
                	var flag=window["layui-layer-iframe" + index].formSubmit();
               	 	if(flag){
       ...
       $('#edit').click(function(e){
        	...
        	var layerEidt=layer.open({
                 ...
                 shade:['0.3','#000'],
                 maxmin: true,
                 content:js_path+'/iconManage/edit?id='+ids[0],
                 btn: ['确认', '取消'],
                 yes: function(index,layero){
                	var flag=window["layui-layer-iframe" + index].formSubmit();
               	 	if(flag){
       ...
       //查询按钮事件
		...
		function queryDynamic(){
			...
			$.ajax({
				type: "POST",
				url: js_path+'/iconManage/queryDynamic',
