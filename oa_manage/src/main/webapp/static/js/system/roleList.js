...
layui.use(['table','form','element','layer'], function(){
        ...
        function editData(item,row){
        	var layerEdit = layer.open({
                ...
                shade: 0,
                maxmin: true,
                content:js_path+'/sysRole/edit?id='+item.id,
                btn: ['确定', '取消'], //只是为了演示
      ...
      //删除调用方法
        ...
        function detailData(item,row){
        	var layerEdit = layer.open({
                ...
                shade: 0,
                maxmin: true,
                content:js_path+'/sysRole/detail?id='+item.id,
                btn: ['关闭'],
                yes: function(index,layero){
                	layer.closeAll();
                }
       ...
       $('#edit').click(function(e){
        	...
        	var layerEidt=layer.open({
                 ...
                 shade:['0.3','#000'],
                 maxmin: true,
                 content:js_path+'/sysRole/edit?id='+ids[0],
                 btn: ['确认', '取消'],
                 yes: function(index,layero){
                	var flag=window["layui-layer-iframe" + index].formSubmit();
               	 	if(flag){
