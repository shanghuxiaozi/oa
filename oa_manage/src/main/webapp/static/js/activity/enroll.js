...
layui.use(['table','form','element','layer'], function(){
        ...
        var options = {
        	...
        	url:js_path+'/OrdinaryActivity/ByActivityIdqueryUser',//查询接口
        ...
        function addData(item,row){
            ...
            function() {
            	...
            	$.ajax({
                    ...
                    dataType: "json",
                    traditional :true, 
                    url: js_path+"/OrdinaryActivity/addPoints",
        ...
        function  subtractData(item,row){
            ...
            function() {
            	...
            	$.ajax({
                    ...
                    dataType: "json",
                    traditional :true, 
                    url: js_path+"/OrdinaryActivity/minusPoints",
                    data:{'activityId':item.activityId,'userId':item.userId},
                    success: function (obj) {
    	               	 if(obj.code==200){
    	               	/*	 queryDynamic();*/
 	      ...
 	      /*	var o=$("#dateTable");  
             ...
             function(){
             	...
             	$.ajax({
                     ...
                     dataType: "json",
                     traditional :true, 
                     url: js_path+"/OrdinaryActivity/batchadd",
                     data:{'ids':ids},
                     success: function (obj) {
     	               	 if(obj.code==200){
     	               		 queryDynamic();
        ...
        $('#minus').click(function (){
            ...
            function() {
            	...
            	$.ajax({
                    ...
                    dataType: "json",
                    traditional :true, 
                    url: js_path+"/OrdinaryActivity/batchminus",
                    data:{'ids':ids},
                    success: function (obj) {
    	               	 if(obj.code==200){
    	               		 queryDynamic();
		...
		function queryDynamic(   ){
			...
			$.ajax({
				type: "POST",
				url: js_path+'/OrdinaryActivity/ByActivityIdqueryUser',
